...
import (
	...
	"github.com/csk6124/vdk/codec"
	"github.com/csk6124/vdk/codec/aacparser"
	"github.com/csk6124/vdk/codec/h264parser"
	"github.com/csk6124/vdk/codec/h265parser"
	"github.com/csk6124/vdk/format/rtsp/sdp"
)
...
func Dial(options RTSPClientOptions) (*RTSPClient, error) {
	...
	// Include the backchannel feature tag in the DESCRIBE request
	headers := map[string]string{
		"Accept":  "application/sdp",
		"Require": "www.onvif.org/ver20/backchannel",
	}
	err = client.request(DESCRIBE, headers, client.pURL.String(), false, false)
	if err != nil {
		return nil, err
	}
